        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecommendationAlerts = table.Column<bool>(type: "bit", nullable: false),
                    TrialEndingReminderDays = table.Column<int>(type: "int", nullable: false),
                    BillingReminderDays = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Color", "CreatedAt", "Description", "IsDefault", "Name" },
                values: new object[,]
                {
                    { 1, "#e74c3c", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Streaming services, games, media", true, "Entertainment" },
                    { 2, "#3498db", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Internet, phone, cloud storage", true, "Utilities" },
                    { 3, "#2ecc71", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Software tools, business apps", true, "Productivity" },
                    { 4, "#f39c12", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Gym memberships, health apps", true, "Health & Fitness" },
                    { 5, "#9b59b6", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Newspapers, learning platforms", true, "News & Education" },
                    { 6, "#95a5a6", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Miscellaneous subscriptions", true, "Other" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_Alert_User_Read_Created",
                table: "Alerts",
