...
const SidebarHeader = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(({ className, ...props }, ref) => {
  return <div ref={ref} className={cn("flex items-center px-4 py-4", className)} {...props} />
})
...
const SidebarNav = React.forwardRef<HTMLElement, React.ComponentProps<"nav">>(({ className, ...props }, ref) => {
  return <nav ref={ref} className={cn("space-y-1 px-2", className)} {...props} />
})
  ...
  return (
    <a
      ...
      className={cn(
        ...
        active && "bg-gray-800 text-orange-400",
        className,
      )}
      {...props}
    >
