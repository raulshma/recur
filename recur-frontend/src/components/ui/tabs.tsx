...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-md bg-gray-100 p-1 text-gray-500 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]",
      className,
    )}
    {...props}
  />
